...

        {
...

            {
...

                {
                    ...
                    Message = "Сейчас справа показан пример карты. На самой карте смотри стоимость, название, ATK/HP/SPD и текст эффекта. Пример останется видимым до следующего шага туториала.",
                    ...
                    PreviewCaption = "Пример: стоимость → имя → ATK/HP/SPD → эффект"
