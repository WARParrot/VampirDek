    ...
    public static class LocalizationService
    {
        ...
        private static void RegisterBuiltInTables()
        {
            RegisterTable("ru", new Dictionary<string, string>
            {
                ...
                ["tutorial.exploration_intro"] = "Исследование — пауза между дуэлями. Здесь вы выбираете риск: бой, награду или отступление.",
                ...
                ["tutorial.exploration_interact_intro"] = "Когда видите подсказку, взаимодействуйте: так открываются объекты, пути и встречи.",
                ["tutorial.exploration_interact_prompt"] = "Посмотрите на объект или встречу и нажмите E.",
                ...
                ["tutorial.exploration_outro"] = "Исследование: осмотритесь, проверьте колоду и выбирайте бой. Любопытство строит забег; спешка может его закончить.",
                ...
                ["tutorial.confirm_building_intro"] = "Отлично: на поле есть Человек и атакующий Вампир. Дальше подтвердим строительство и выберем цель атаки.",
            ...
            RegisterTable("en", new Dictionary<string, string>
            {
                ...
                ["tutorial.exploration_interact_intro"] = "When the world answers, interact. This is how you inspect objects, open paths, and commit to nearby encounter points.",
                ["tutorial.exploration_interact_prompt"] = "Face an interactable prompt or encounter, then press E.",
