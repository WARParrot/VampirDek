    ...
    public static class LocalizationService
    {
        ...
        private static void RegisterBuiltInTables()
        {
            RegisterTable("ru", new Dictionary<string, string>
            {
                ...
                ["tutorial.planning_intro"] = "Фаза планирования: здесь назначаются атаки.\n\nУправление целью: зажмите своего живого бойца с АТК > 0 — например Вампира в Авангарде — и протяните линию к карте противника. Чтобы отменить выбранную цель, выберите союзную карту или пустой слот.",
                ["tutorial.select_target"] = "Отпустите на живой карте противника. Красная линия/подсветка означает выбранную цель; союзная или пустая клетка отменяет выбор.",
            ...
            RegisterTable("en", new Dictionary<string, string>
            {
                ...
                ["tutorial.planning_intro"] = "Planning Phase: assign attacks here.\n\nTarget controls: hold your living fighter with ATK > 0 — for example, Vampire in Vanguard — and drag to an enemy card. To cancel the chosen target, choose an allied card or an empty slot.",
                ["tutorial.select_target"] = "Release on a living enemy card. The red line/highlight means the target is selected; an allied or empty slot cancels it.",
