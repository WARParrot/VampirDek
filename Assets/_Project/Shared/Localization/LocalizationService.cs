    ...
    public static class LocalizationService
    {
        ...
        private static void RegisterBuiltInTables()
        {
            RegisterTable("ru", new Dictionary<string, string>
            {
                ...
                ["interaction.next_night"] = "Войти в следующую ночь",
                ["interaction.win_duel_to_enter"] = "Победите в дуэли, чтобы войти.",
            ...
            RegisterTable("en", new Dictionary<string, string>
            {
                ...
                ["interaction.next_night"] = "Enter the next night",
                ["interaction.win_duel_to_enter"] = "Win the duel to enter.",
